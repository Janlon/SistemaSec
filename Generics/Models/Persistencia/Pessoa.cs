namespace Generic.Models
{
    ...
    public class Pessoa : EntidadeBase
    {
        ...
        public virtual string Email { get { return Cryptis.Text.AESDecrypt(XEmail, DataKey); } set { XEmail = Cryptis.Text.AESEncrypt(value, DataKey); } }

        [NotMapped()]
        [StringLength(100, ErrorMessage = "{0} deve ter entre {2} e {1} dígitos/caracteres.", MinimumLength = 5)]
        [Column(TypeName = "VARCHAR")]
        public virtual string Nome { get { return Cryptis.Text.AESDecrypt(XNome, DataKey); } set {XNome = Cryptis.Text.AESEncrypt(value, DataKey); } }

        [NotMapped()]
        [Required(AllowEmptyStrings =true)]
        [StringLength(100, ErrorMessage = "{0} deve ter entre {2} e {1} dígitos/caracteres.", MinimumLength = 2)]
        [Column(TypeName = "VARCHAR")]
        public virtual string Apelido { get { return Cryptis.Text.AESDecrypt(XApelido, DataKey); } set { XApelido = Cryptis.Text.AESEncrypt(value, DataKey); } }
        ...
        [StringLength(100, ErrorMessage = "{0} deve ter entre {2} e {1} dígitos/caracteres.", MinimumLength = 2)]
        [Column(TypeName = "VARCHAR")]
        public virtual string Atividade { get { return Cryptis.Text.AESDecrypt(XAtividade, DataKey); } set { XAtividade = Cryptis.Text.AESEncrypt(value, DataKey); } }

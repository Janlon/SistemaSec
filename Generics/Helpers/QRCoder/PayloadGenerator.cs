...
namespace Generics.QRCoder
{
    public static class PayloadGenerator
    {
        public abstract class Payload
        {
            ...
            public virtual ECCLevel EccLevel { get { return ECCLevel.M; } }
            public virtual EciMode EciMode { get { return EciMode.Default; } }
        ...
        public class OneTimePassword : Payload
        {
            ...
            {
                if (StaticMethods.IsNullOrWhiteSpace(Secret))
                {
                ...
                if (!StaticMethods.IsNullOrWhiteSpace(Issuer))
                {
                    if (Issuer.Contains(":"))
                    {
                ...
                if (!StaticMethods.IsNullOrWhiteSpace(Label))
                {
                    if (Label.Contains(":"))
                    {

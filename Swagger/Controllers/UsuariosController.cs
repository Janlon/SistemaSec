...
namespace Swagger.Controllers
{
    ...
    public class UsuariosController : ApiController
    {
        ...
        [AllowAnonymous()]
        [Route("Register")]
        public async Task<CrudResult<RegisterViewModel>> Register([FromBody]RegisterViewModel model)
        {
            return await Engine.Users.Register(model);
        }
        ...
        //        return Redirect((new ChallengeResult(provider, "")).RedirectUri);//, this);
        //    ExternalLoginData externalLogin = ExternalLoginData.FromIdentity(User.Identity as ClaimsIdentity);
        ...
        public UsuariosController(ApplicationUserManager userManager, ISecureDataFormat<AuthenticationTicket> accessTokenFormat)
        {

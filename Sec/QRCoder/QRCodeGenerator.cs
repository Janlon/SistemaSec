namespace Sec.QRCoder
{
    ...
    public class QRCodeGenerator : IDisposable
    {
        ...
        /// <summary>
        /// Calcula os dados do código QR que podem ser usados na renderização para gerar a representação gráfica.
        /// </summary>
        /// <param name="payload">Objeto gerado por uma instância do tipo <see cref="PayloadGenerator"/>.</param>
        /// <exception cref="Exceptions.DataTooLongException">Excessão que será disparada quando os dados ultrapassem os limites.</exception>
        /// <returns>Retorna os dados á serem renderizados.</returns>
        ...
        /// </summary>
        /// <param name="payload">Objeto gerado por uma instância do tipo <see cref="PayloadGenerator"/>.</param>
        /// <param name="eccLevel">Nível de precisão</param>
        /// <exception cref="Exceptions.DataTooLongException">Excessão que será disparada quando os dados ultrapassem os limites.</exception>
        /// <returns>Retorna os dados á serem renderizados.</returns>
        ...
        /// Calcula os dados do código QR que podem ser usados na renderização para gerar a representação gráfica.
        /// </summary>
        /// <param name="plainText">Texto para a composição dos dados do código QR.</param>
        /// <param name="eccLevel">Nível de precisão</param>
        /// <param name="forceUtf8">Deve forçar o uso do UTF-8?</param>
        /// <param name="utf8BOM">Deve forçar o byte-order-mark?</param>
        /// <param name="eciMode">Modo ECI à ser utilizado.</param>
        /// <param name="requestedVersion">Versão de QR code.</param>
        /// <exception cref="Exceptions.DataTooLongException">Excessão que será disparada quando os dados ultrapassem os limites.</exception>
        /// <returns>Retorna os dados á serem renderizados.</returns>
        ...
        /// Calcula os dados do código QR que podem ser usados na renderização para gerar a representação gráfica.
        /// </summary>
        /// <param name="binaryData">Matriz binária para a composição dos dados do código QR.</param>
        /// <param name="eccLevel">Nível de precisão</param>
        /// <exception cref="Exceptions.DataTooLongException">Excessão que será disparada quando os dados ultrapassem os limites.</exception>
        /// <returns>Retorna os dados á serem renderizados.</returns>
        ...
        /// <summary>
                /// Calcula os dados do código QR que podem ser usados na renderização para gerar a representação gráfica.
        /// </summary>
        /// <param name="binaryData">Matriz binária cvom os dados para o QR code</param>
        /// <param name="eccLevel">Nível de precisão</param>
        /// <exception cref="Exceptions.DataTooLongException">Excessão que será disparada quando os dados ultrapassem os limites.</exception>
        /// <returns>Retorna os dados á serem renderizados.</returns>
        ...
        /// <summary>
        /// Retorna a linha de texto formatada.
        /// </summary>
        /// <param name="level"></param>
        /// <param name="maskVersion"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Retorna a composição da versão.
        /// </summary>
        /// <param name="version"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Auxiliar para calcular o posicionamento.
        /// </summary>
